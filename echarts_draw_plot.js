...
let res = [
    { 'name': 1, 'value': 12, 'color': 'red', 'x': 31.003952, 'y': 9.190166 }, {
        'name': 2,
        'value': 12,
        'color': 'red',
        'x': 31.751667,
        'y': 9.655871
    }, { 'name': 3, 'value': 12, 'color': 'red', 'x': 32.724873, 'y': 9.820409 }, {
        'name': 4,
        'value': 12,
        'color': 'red',
        'x': 33.65395,
        'y': 9.928507
    }, { 'name': 5, 'value': 12, 'color': 'red', 'x': 34.1367, 'y': 9.789901 }, {
        'name': 6,
        'value': 12,
        'color': 'red',
        'x': 34.534367,
        'y': 9.778688
    }, { 'name': 7, 'value': 12, 'color': 'red', 'x': 37.08625, 'y': 9.375624 }, {
        'name': 8,
        'value': 12,
        'color': 'red',
        'x': 37.4749,
        'y': 9.668628
    }, { 'name': 9, 'value': 12, 'color': 'red', 'x': 38.64688, 'y': 9.422077 }, {
        'name': 10,
        'value': 12,
        'color': 'red',
        'x': 39.295002,
        'y': 8.417988
    }, { 'name': 1, 'value': 12, 'color': 'yellow', 'x': 35.453655, 'y': 10.197328 }, {
        'name': 2,
        'value': 12,
        'color': 'yellow',
        'x': 36.143257,
        'y': 10.511192
    }, { 'name': 3, 'value': 12, 'color': 'yellow', 'x': 36.331028, 'y': 9.898713 }, {
        'name': 4,
        'value': 12,
        'color': 'yellow',
        'x': 36.786102,
        'y': 10.642619
    }, { 'name': 5, 'value': 12, 'color': 'yellow', 'x': 37.244278, 'y': 10.590374 }, {
        'name': 6,
        'value': 12,
        'color': 'yellow',
        'x': 37.892685,
        'y': 10.147951
    }, { 'name': 7, 'value': 12, 'color': 'yellow', 'x': 38.090897, 'y': 10.473176 }, {
        'name': 8,
        'value': 12,
        'color': 'yellow',
        'x': 39.730946,
        'y': 8.195225
    }, { 'name': 9, 'value': 12, 'color': 'yellow', 'x': 39.83897, 'y': 7.748148 }, {
        'name': 10,
        'value': 12,
        'color': 'yellow',
        'x': 40.200176,
        'y': 7.483844
    }, { 'name': 11, 'value': 12, 'color': 'yellow', 'x': 40.390934, 'y': 7.37273 }]
...
res = res.map((e, index) => {
    if (index < res.length - 1) {
        edges.push({
            ...
            symbol: ['none', 'arrow'], // 设置箭头样式，第一个箭头是起点箭头，第二个箭头是终点箭头
